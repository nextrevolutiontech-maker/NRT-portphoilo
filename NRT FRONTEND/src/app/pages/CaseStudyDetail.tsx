  ...
  if (!study) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#F3F4F6] text-[#0F172A] p-6">
        ...
        <Link to="/case-studies" className="bg-[#0F172A] text-white px-6 py-3 rounded-xl font-bold">Back to Case Studies</Link>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[#F3F4F6] text-[#0F172A] overflow-x-hidden">
      ...
      <section className="pt-32 pb-40 px-4 sm:px-6 lg:px-12 xl:px-24 bg-[#0F172A] text-white relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <Link to="/case-studies" className="inline-flex items-center gap-2 font-black text-white/40 hover:text-white mb-12 transition-colors uppercase tracking-widest text-[10px]">
             <ArrowLeft className="w-4 h-4" /> All Case Studies
          </Link>

          <div className="grid lg:grid-cols-2 gap-16 items-center">
             <div>
                <div className="text-[10px] font-black uppercase tracking-[0.4em] text-[#3A5CCC] mb-6">{study.category}</div>
                <h1 className="text-4xl sm:text-6xl lg:text-7xl font-black mb-8 tracking-tighter leading-tight">{study.title}</h1>
                <div className="inline-block px-4 py-2 bg-white/5 border border-white/10 rounded-lg text-sm font-bold text-white/80 mb-10">
                   {study.client}
                </div>
                ...
                <div className="flex gap-8 border-t border-white/10 pt-8 mt-4">
                   <div>
                      ...
                      <div className="flex items-center gap-2 text-lg font-bold"><Clock className="w-5 h-5 text-[#14B8A6]" /> {study.timeline}</div>
                   </div>
                   <div>
                      <div className="text-[10px] font-black uppercase tracking-widest text-white/40 mb-2">Impact</div>
                      <div className="flex items-center gap-2 text-lg font-bold"><TrendingUp className="w-5 h-5 text-[#14B8A6]" /> Proven ROI</div>
                   </div>
                </div>
             </div>
             
             <div className="relative rounded-[2rem] sm:rounded-[3rem] overflow-hidden shadow-2xl border border-white/10 p-8 sm:p-12 bg-white/5 backdrop-blur-md flex items-center justify-center">
         ...
         <div className="mx-auto max-w-7xl grid lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-8 space-y-20">
               ...
               <div className="space-y-6">
                  <h2 className="text-3xl font-black tracking-tight border-b-2 border-black/5 pb-4">The Challenge</h2>
                  <p className="text-lg font-semibold text-[#0F172A]/70 leading-relaxed">
                     {study.problem}
                  </p>
               </div>

               <div className="space-y-6">
                  <h2 className="text-3xl font-black tracking-tight border-b-2 border-black/5 pb-4">The Solution</h2>
                  <p className="text-lg font-semibold text-[#0F172A]/70 leading-relaxed">
                     {study.solution}
                  </p>
               </div>
               ...
               <div className="space-y-6">
                  <h2 className="text-3xl font-black tracking-tight border-b-2 border-black/5 pb-4 flex items-center gap-3">
                     <Server className="w-8 h-8 text-[#3A5CCC]" /> Architecture
                  </h2>
                  <p className="text-lg font-semibold text-[#0F172A]/70 leading-relaxed">
                     {study.architecture}
                  </p>
               ...
               <div className="space-y-6">
                  <h2 className="text-3xl font-black tracking-tight border-b-2 border-black/5 pb-4 flex items-center gap-3">
                     <TrendingUp className="w-8 h-8 text-[#14B8A6]" /> Final Results & Business Impact
                  </h2>
                  <div className="bg-white p-8 sm:p-10 rounded-[2rem] border border-black/5 shadow-lg">
                     <ul className="space-y-5 mb-8">
                        {study.results.map((res: string, i: number) => (
                          <li key={i} className="flex items-start gap-4">
                             <CheckCircle2 className="w-6 h-6 text-[#14B8A6] shrink-0 mt-0.5" />
                             <span className="text-lg font-bold text-[#0F172A]/80">{res}</span>
                          </li>
                        ))}
                     </ul>
                     <div className="p-6 bg-[#0F172A] text-white rounded-xl">
                        <div className="text-[10px] font-black uppercase tracking-widest text-white/50 mb-2">Bottom Line Impact</div>
            ...
            <div className="lg:col-span-4 space-y-8 lg:sticky lg:top-32">
               <div className="bg-white p-8 rounded-[2rem] border border-black/5 shadow-xl">
                  <h3 className="text-sm font-black uppercase tracking-[0.2em] text-[#0F172A]/50 mb-6 flex items-center gap-2">
                     <Layout className="w-4 h-4" /> Technology Stack
                  </h3>
                  <div className="flex flex-wrap gap-3">
                     {study.stack.map((tech: string, i: number) => (
                       <span key={i} className="px-4 py-2 bg-[#F3F4F6] text-[#0F172A] rounded-lg text-sm font-bold border border-black/5">
                          {tech}
                       </span>
                     ))}
                  </div>
               ...
               <div className="bg-gradient-to-br from-[#0F172A] to-[#161F33] p-10 rounded-[2rem] text-white shadow-2xl relative overflow-hidden border border-white/5">
                  ...
                  <div className="relative z-10 text-center">
                     ...
                     <p className="text-sm font-bold text-white/60 mb-8">Book a technical audit with our engineering team today.</p>
                     <Link to="/contact" className="block w-full bg-[#3A5CCC] text-white py-4 rounded-xl font-black shadow-lg hover:bg-[#4F7FFF] transition-colors mb-6">
                        Book Consultation
                     </Link>
                  </div>
               </div>
               ...
               <div className="bg-white p-8 rounded-[2rem] border border-black/5 shadow-xl">
                  <h3 className="text-sm font-black uppercase tracking-[0.2em] text-[#0F172A]/50 mb-6">Related Services</h3>
               ...
               <div className="bg-white p-8 rounded-[2rem] border border-black/5 shadow-xl">
                  <div className="flex items-center gap-4 mb-4">
                     <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-[#3A5CCC]/20">
                     ...
                     <div>
                        <div className="text-xs font-black uppercase tracking-widest text-[#0F172A]/40 mb-1">Written By</div>
                        <Link to="/author/muhammad-ahsan-khan" className="text-lg font-black text-[#0F172A] hover:text-[#3A5CCC] transition-colors block">
                           Muhammad Ahsan Khan
                        </Link>
                        <div className="text-sm font-bold text-[#0F172A]/60 font-italic-serif italic">Founder & Lead Architect</div>
                     </div>
                  </div>
               </div>
            </div>
