    ...
    <div className="min-h-screen bg-white text-slate-900 overflow-hidden">
      ...
      <section className="pt-32 pb-40 px-4 sm:px-6 lg:px-12 xl:px-24 bg-white text-slate-900 relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl relative z-10 text-center">
           <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-slate-300 mb-8">
              <span className="w-2 h-2 rounded-full bg-slate-900 animate-pulse" />
              <span className="text-[10px] font-bold uppercase tracking-widest text-slate-900/80">Enterprise Methodology</span>
           </div>
           ...
           <p className="text-xl sm:text-2xl font-bold text-slate-900/50 leading-relaxed max-w-3xl mx-auto">
         ...
         <div className="mx-auto max-w-7xl space-y-16">
            {steps.map((step, i) => (
              <motion.div 
                ...
                viewport={{ once: true }}
                className="bg-white rounded-[3rem] p-10 sm:p-16 border border-slate-300 shadow-xl relative overflow-hidden group"
              >
                 ...
                 <div className="grid lg:grid-cols-12 gap-12 items-center relative z-10">
                    <div className="lg:col-span-4">
                       <div className="text-[10px] font-black uppercase tracking-[0.4em] text-orange-600 mb-4">{step.num}</div>
                       <h2 className="text-4xl font-black tracking-tighter text-slate-900 leading-tight mb-6">{step.title}</h2>
                       <div className="w-16 h-16 rounded-2xl bg-white flex items-center justify-center text-orange-600 border border-slate-300">
                          {step.icon}
                       </div>
                    </div>
                    <div className="lg:col-span-8">
                       <p className="text-xl sm:text-2xl font-semibold text-slate-600 leading-relaxed border-l-4 border-orange-600 pl-8">
                          {step.desc}
                       </p>
                    </div>
                 </div>
      ...
      <section className="py-32 px-4 bg-white text-slate-900 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
           ...
           <p className="text-xl text-slate-900/50 mb-12">Let's discuss your current infrastructure and apply our discovery framework to your next big project.</p>
           <Link to="/contact" className="inline-flex items-center gap-4 bg-orange-600 text-white px-10 py-5 rounded-2xl text-xl font-black shadow-lg hover:bg-[#4F7FFF] transition-all">
