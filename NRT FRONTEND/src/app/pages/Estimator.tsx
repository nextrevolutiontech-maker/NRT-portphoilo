...
export function CostEstimator() {
    ...
    return (
        <div className="pt-20 min-h-screen bg-white text-slate-900 overflow-x-hidden">
            <SEO 
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="pt-12 pb-24 text-center sm:text-left">
                    <h1 className="text-4xl sm:text-7xl lg:text-[8rem] font-black tracking-tighter leading-[0.95] sm:leading-[0.85] mb-10">
                       Project <br />
                       <span className="text-orange-600">Estimator</span>.
                    </h1>
                    <p className="text-xl sm:text-3xl font-bold text-slate-400 leading-tight max-w-2xl">
                       Get a rough idea of your project investment in seconds.
                    </p>
                </div>

                <div className="relative bg-white rounded-[3rem] sm:rounded-[4rem] shadow-2xl border border-slate-300 p-8 sm:p-20 mb-32 overflow-hidden">
                    ...
                    {!showResult ? (
                        <div className="flex flex-col relative z-10">
                            {steps[currentStep] && (
                                <>
                                    <div className="w-full bg-white h-3 rounded-full mb-16 overflow-hidden border border-slate-300">
                                        <motion.div 
                                        ...
                                        <AnimatePresence mode="wait">
                                            ...
                                            >
                                                <div className="flex items-center gap-4 mb-4">
                                                    <div className="text-[11px] font-black uppercase tracking-[0.4em] text-orange-600">Step 0{currentStep + 1}</div>
                                                </div>
                                                <h2 className="text-4xl sm:text-6xl font-black mb-6 tracking-tighter leading-none">{steps[currentStep].title}</h2>
                                                <p className="text-lg sm:text-2xl font-bold text-slate-400 mb-12">{steps[currentStep].description}</p>
                                                        ...
                                                        return (
                                                            <motion.div
                                                                ...
                                                                className={`relative p-8 rounded-[2rem] sm:rounded-[2.5rem] cursor-pointer transition-all duration-300 overflow-hidden group ${
                                                                    ...
                                                                    : "bg-gradient-to-br from-[#F8FAFC] to-[#F1F5F9] border border-slate-300 shadow-[inset_0_1px_0_rgba(255,255,255,0.6)] hover:shadow-xl hover:border-orange-600/20"
                                                                }`}
                                                            >
                                                                ...
                                                                <div className={`absolute -top-12 -right-12 w-24 h-24 rounded-full blur-2xl transition-all duration-500 ${isSelected ? "bg-orange-600/20" : "bg-transparent group-hover:bg-orange-600/10"}`} />

                                                                <div className="relative z-10">
                                                                    <div className="flex items-center justify-between mb-8">
                                                                       <div className={`w-14 h-14 rounded-2xl flex items-center justify-center transition-all duration-300 ${
                                                                           isSelected 
                                                                           ? "bg-orange-600 text-white shadow-lg shadow-[#3A5CCC]/30" 
                                                                           : "bg-white text-slate-900 shadow-md group-hover:scale-110 group-hover:text-orange-600"
                                                                       }`}>
                                                                       ...
                                                                       <div className={`w-8 h-8 rounded-full border-2 flex items-center justify-center transition-all duration-300 ${
                                                                           isSelected 
                                                                           ? "bg-orange-600 border-orange-600 text-white scale-100 opacity-100 shadow-md" 
                                                                           : "border-slate-300 text-transparent scale-90 opacity-50 group-hover:border-orange-600/30 group-hover:scale-100"
                                                                       }`}>
                                                                    ...
                                                                    <div className="space-y-2">
                                                                        ...
                                                                        {option.description && (
                                                                            <p className={`text-sm font-bold transition-colors duration-300 ${
                                                                                isSelected ? "text-slate-900/60" : "text-slate-400 group-hover:text-slate-900/50"
                                                                            }`}>
                                                                                {option.description}
                                                                            </p>
                                                                        )}
                                                                        {option.cost > 0 && (
                                                                            <div className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-sm font-black transition-all duration-300 mt-3 ${
                                                                                ...
                                                                                : "bg-black/5 text-slate-400 group-hover:bg-orange-600/5 group-hover:text-orange-600"
                                                                            }`}>
                                                                                + ${option.cost}
                                                                            </div>
                                                                        )}
                                    ...
                                    <div className="flex justify-between items-center mt-16 pt-12 border-t border-slate-300">
                                        <button 
                                            onClick={prevStep} 
                                            disabled={currentStep === 0} 
                                            className="flex items-center gap-3 text-lg font-black text-slate-400 hover:text-slate-900 disabled:opacity-0 transition-all uppercase tracking-widest"
                                        >
                                        ...
                                        <button 
                                            ...
                                            className="bg-white text-slate-900 px-12 py-5 rounded-2xl text-xl font-black shadow-xl hover:bg-orange-600 disabled:opacity-30 transition-all flex items-center gap-4"
                                        >
                        ...
                        <div className="text-center relative z-10 py-12">
                            <motion.div 
                                ...
                                className="w-24 h-24 bg-gradient-to-br from-[#3A5CCC] to-[#27324A] rounded-[2rem] flex items-center justify-center mx-auto mb-12 text-slate-900 shadow-2xl shadow-[#3A5CCC]/40"
                            >
                                <Calculator className="w-12 h-12" />
                            </motion.div>
                            <h2 className="text-4xl sm:text-6xl font-black mb-8 tracking-tighter">Estimated Investment</h2>
                            <div className="text-[6rem] sm:text-[10rem] font-black text-slate-900 mb-12 tracking-tighter leading-none">
                                ${calculateTotal().toLocaleString()}
                            </div>
                            <p className="text-xl sm:text-2xl font-bold text-slate-400 mb-16 max-w-xl mx-auto">
                            ...
                            <form onSubmit={handleEstimateSubmit} className="max-w-xl mx-auto space-y-6">
                                <div className="grid sm:grid-cols-2 gap-6 text-left">
                                    <div>
                                        <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-4 mb-2 block">Your Name</label>
                                        <input type="text" placeholder="John Doe" className="w-full bg-white border border-slate-300 rounded-2xl p-6 font-black text-lg focus:ring-2 focus:ring-[#3A5CCC] transition-all" value={name} onChange={e => setName(e.target.value)} required />
                                    </div>
                                    <div>
                                        <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-4 mb-2 block">Work Email</label>
                                        <input type="email" placeholder="john@company.com" className="w-full bg-white border border-slate-300 rounded-2xl p-6 font-black text-lg focus:ring-2 focus:ring-[#3A5CCC] transition-all" value={email} onChange={e => setEmail(e.target.value)} required />
                                    </div>
                                </div>
                                <button type="submit" disabled={loading} className="w-full bg-orange-600 text-white py-6 rounded-2xl text-2xl font-black shadow-2xl hover:scale-105 transition-all flex items-center justify-center gap-4 group">
                            ...
                            <button onClick={() => { setShowResult(false); setCurrentStep(0); setSelections({}); }} className="mt-16 text-slate-400 font-black uppercase tracking-[0.4em] text-xs hover:text-orange-600 transition-colors">
