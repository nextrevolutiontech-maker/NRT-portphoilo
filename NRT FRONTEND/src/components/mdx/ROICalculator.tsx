    ...
    <div className="my-12 bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden">
      ...
      <div className="p-8 grid md:grid-cols-2 gap-12">
        ...
        <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
           ...
           <Link to="/contact" className="w-full bg-primary hover:bg-primary/90 text-white font-bold py-3 rounded-xl flex items-center justify-center gap-2 transition-colors">
