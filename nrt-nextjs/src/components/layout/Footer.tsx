  ...
  return (
    <footer className="bg-white border-t border-slate-300 text-slate-900 pt-24 pb-12 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-12 xl:px-24 relative z-10">
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-11 h-11 rounded-xl bg-white border border-slate-300 flex items-center justify-center text-slate-900/55 hover:bg-orange-600 hover:text-white hover:border-orange-600 transition-all"
                >
                  {social.icon}
                </a>
              ))}
        ...
        <div className="pt-10 border-t border-slate-300 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <button
            ...
            className="w-10 h-10 rounded-xl bg-white border border-slate-300 flex items-center justify-center text-slate-900 hover:bg-orange-600 hover:text-white transition-all shadow-xl group"
          >
