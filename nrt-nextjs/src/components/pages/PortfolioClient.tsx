    ...
    <div className="min-h-screen bg-white text-slate-900 overflow-x-hidden">
      ...
      <section className="pt-32 pb-24 px-4 sm:px-6 lg:px-12 xl:px-24 bg-white text-slate-900 relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <Link href="/" className="inline-flex items-center gap-2 text-slate-900/50 hover:text-slate-900 mb-8 font-black uppercase text-xs tracking-widest transition-all">
      ...
      <section className="py-32 px-4 sm:px-6 lg:px-12 xl:px-24 text-center bg-white text-slate-900 relative overflow-hidden">
         ...
         <div className="mx-auto max-w-4xl relative z-10">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
               ...
               <Link href="/services" className="bg-white/5 border border-slate-300 text-slate-900 px-12 py-5 rounded-2xl text-xl font-black hover:bg-white/10 transition-all flex items-center justify-center">
                  Explore Solutions
               </Link>
            </div>
         </div>
