         ...
         <div className="mx-auto max-w-7xl relative z-10">
            <div className="bg-white rounded-3xl sm:rounded-[4rem] p-12 sm:p-24 text-center border border-slate-300 shadow-2xl relative overflow-hidden">
               ...
               <div className="flex flex-col sm:flex-row justify-center gap-6 relative z-10">
                  <Link href="/contact" className="bg-orange-600 hover:bg-orange-700 text-white px-10 py-6 rounded-full text-lg sm:text-xl font-black uppercase tracking-widest shadow-xl transition-all flex items-center justify-center gap-3">
                     Book Strategy Call <ArrowRight className="w-6 h-6" />
                  </Link>
                  <Link href="/services" className="bg-transparent border border-black/20 text-slate-900 px-10 py-6 rounded-full text-lg sm:text-xl font-black uppercase tracking-widest hover:bg-white hover:text-slate-900 transition-all flex items-center justify-center">
                     Explore Solutions
                  </Link>
               </div>
            </div>
